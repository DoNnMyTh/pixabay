"""
Copyright (c) 2020 donnmyth and contributors
...
class Image(IPixabay):
    ...
    def search(self,
        ...
        :param editors_choice :type bool (pixabay use "true" and "false" string instead)
        :desc Select images that have received
        an Editor's Choice award.
        Accepted values: "true", "false"
        Default: "false"

        :param safesearch :type bool (pixabay use "true" and "false" string instead)
        ...
        :param pretty :type bool (pixabay use "true" and "false" string instead)
